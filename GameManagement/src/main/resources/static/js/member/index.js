...
function getTableColumns() {
    return [[
        ...
        , {field: 'phone', title: '等级', width: 150, templet: function (d) {
                ...
                if(d.permissionRole == "ROLE_ADMIN"){
                    permissionRole = "管理员";
        ...
        , {field: 'balance', title: '金额', width: 150, sort: true, templet: function (d) {
                return "<span style='color: #c2330f;'>" + d.balance + "</span>";
            }}
        , {field: 'isEnable', title: '状态', width: 120, sort:true,  templet: function (d) {
               var state = "冻结";
                if(d.isDelete == 1){
                    state = "已注销";
