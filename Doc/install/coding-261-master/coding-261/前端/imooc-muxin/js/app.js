window.app = {
	 ...
	 * netty服务后端发布的url地址
	 */
	nettyServerUrl: 'ws://193.112.151.148:8088/ws',
	
	/**
	 * 后端服务发布的url地址
	 */
	serverUrl: 'http://193.112.151.148:8080',
	
	/**
	 * 图片服务器的url地址
	 */
	imgServerUrl: 'http://193.112.151.148:88/imooc/',
	 ...
	 */
	getGroupInformation: function(param, callback, errorCallback){
		callback = callback || $.noop; 
		mui.ajax("http://132.232.61.181:59845/api/home/getGroupInformation", {
			type: "get",
			data: param,	
	...
	getVersion: function(param, callback, errorCallback){ 
		callback = callback || $.noop; 
		mui.ajax("http://132.232.61.181:59845/api/bootstrap/version", {
			type: "get",
			data: param,	
			success: function(data){
				console.log(JSON.stringify(data))
